...
col2.write(
  "According to the table there is no null values, that's good because it keeps the data consistent."
)
st.markdown("""---""")
st.header('Cleaning')
st.write("\n")
...
col2.write(
  " The salary, salary currency, were dropped because they were useless becuase the data already had salary in usd. employment type was dropped because we didn't need it."
)
st.write(
